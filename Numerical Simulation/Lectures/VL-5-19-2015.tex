...
J(y, u, v) &\coloneqq& \frac{\lambda_\Omega}{2} \| y - y_\Omega \|_{L^2(\Omega)}^2 + \frac{\lambda_\Gamma}{2} \| y - y_\Gamma \|_{L^2(\Gamma)}^2 \\
&& \;\; {} + \frac{\lambda_u}{2} \| u \|_{L^2(\Omega)} + \frac{\lambda_v}{2} \| v \|_{L^2(\Gamma_1)}^2
\end{IEEEeqnarraybox} \\
subject to & 
\left\{ \begin{IEEEeqnarraybox}[][c]{rCl"l}
\mathcal{A}y + c_0 y &=& \beta_\Omega u & \text{in $\Omega$}, \\
\partial_{\nu_\mathcal{A}} y + \alpha y &=& \beta_\Gamma v & \text{on $\Gamma_1$}, \\
y &=& 0 & \text{on $\Gamma_0$},
\end{IEEEeqnarraybox} \right. \\
and &
...
minimize & f(u) &=& \frac{\lambda_\Omega}{2} \| S(u, v) - y_\Omega \|_{L^2(\Omega)}^2 + \frac{\lambda_\Gamma}{2} \| S_\Gamma(u, v) - y_\Gamma \|_{L^2(\Gamma)}^2 \\
&&& \;\; {} + \frac{\lambda_u}{2} \| u \|_{L^2(\Omega)}^2 + \frac{\lambda_v}{2} \| v \|_{L^2(\Gamma_1)}^2 \\
...
State equation:
\begin{IEEEeqnarray*}{rCl"l}
- \lapl y &=& 0 & \text{in } \Omega \\
\partial_{\nu} y &=& \alpha(v - y) & \text{on } \Gamma. 
\end{IEEEeqnarray*}
