...
\begin{theorem}[Implicit function theorem]\label{theorem_1.26}
	Let $U,V,W$ be Banach-spaces, and let $\Phi:\mathcal{O}(u_0,v_0)\subseteq U\times V\to W$ %O = Neighbourhood of u_0,v_0
...
\begin{proof}
	...
	\begin{IEEEeqnarray}{rCl}
		...
		&& \underbrace{\|A(u)(v(u)-v(z))\|}_{\leq\frac{1}{2}\|v(u)-v(z)\|} + \underbrace{\|(A(u)-A(z))v(z)\|}_{\to 0\text{ for }u\to z} \nonumber
	\end{IEEEeqnarray}
...
\begin{theorem}[Ljusternik, 1934]\label{theorem_1.29}
