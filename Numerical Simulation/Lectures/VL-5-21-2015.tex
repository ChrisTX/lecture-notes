...
minimize & \IEEEeqnarraymulticol{4}{l}{ \frac{1}{2} \| y - y_\Omega \|_{L^2(\Omega)}^2 + \frac{\lambda}{2} \| u \|_{L^2(\Omega)}^2 } \\
subject to & - \lapl y &=& \beta \cdot u & \text{in } \Omega \\
& y &=& 0 & \text{on } \Gamma \\
and & u_a(x) &\leq& u(x) \leq u_b(x) & \text{\ac{ae}} 
\end{IEEEeqnarray*}
Here,
\[
