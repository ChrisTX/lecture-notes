...
\begin{document}
	...
	\begin{IEEEeqnarray*}{rCl}
	\frac{|g(w)|}{\| w \|} &\leq& \frac{\lambda \| b - v\|}{\lambda \inf \| b \|} \\
	&\leq& 1 - \frac{\varepsilon}{\inf \| b - u\| } \eqqcolon C_\varepsilon.
	\end{IEEEeqnarray*}
	Hence,
	\[
	...
	It holds:
	\begin{IEEEeqnarray*}{rCl}
	D &\geq& \frac{1}{C_\varepsilon} \tilde{g}(b) \\
	&=& \frac{1}{C_\varepsilon}(b - v) \\
	&=& \| b - v \| \frac{1}{C_\varepsilon} \\
	&\geq& \inf \| b - u \| \frac{1}{C_\varepsilon}.
	\end{IEEEeqnarray*}
	By $\varepsilon \to 0$:
	\[
		D \geq \inf \| b - u \|.
