...
\begin{IEEEeqnarray*}{rCl}
0 &\leq& \underbrace{ f(u^*) }_{=f(\bar{u})} - f_{\gamma_n} (\bar{u}_{\gamma_n}) \\
&\leq& f(u^*) - f(\bar{u}_{\gamma_n}) \\
&=& - f'(u^*) (\bar{u}_{\gamma_n} - u^*) - \frac{1}{2} f''(u_\xi) ( \bar{u}_{\gamma_n} - u^*)^2 \\
&\overset{\text{coercivity of } f''}{\leq}& - c \| \bar{u}_{\gamma_n} - u^* \|^2 - f'(u^*)(\bar{u}_{\gamma_n} - u^*).
\end{IEEEeqnarray*}
By bringing the first term from the right hand side to the left one:
\begin{IEEEeqnarray*}{rCl}
c \| \bar{u}_{\gamma_n} - u^* \|^2 &\leq& f'(u^*)(\bar{u}_{\gamma_n} - u^*) \\
&=& - ( \underbrace{( \bar{y}_{\gamma_n} - y^*, y^* - y_d)}_{\to 0, \text{ since } \bar{y}_{\gamma_n} \to y^*} + \lambda \underbrace{(u^*, \bar{u}_{\gamma_n} - u^*)}_{\to 0, \text{ since } \bar{u}_{\gamma_n} \rightharpoonup u^*} ) \\
&\to& 0
\end{IEEEeqnarray*}
