...
&=& \int_\Omega \varphi_y(x, y(x)) \underbrace{ \tilde{y}(x) }_{G'(u)h} \dx + \int_\Omega \psi(x, u(x)) h \dx.
\end{IEEEeqnarray*}
...
\begin{IEEEeqnarray*}{rCl}
\tilde{\mathscr{F}} u_2 &=& \frac{\mathrm{d}}{\mathrm{d}t} \tilde{\mathscr{F}}(u + t u_2) |_{t=0} \\
