...
&\leq& \underbrace{ \left\| y(u) - y_h(u) \right\| }_{\leq ch^2 \| \nabla^2 y(u) \| \leq ch^2 \| u \|} \underbrace{ \left\| y(v) \right\| }_{\leq c \| v \|} + \underbrace{ \left\| y_h(u) - y_d \right\| }_{\leq \| y_d(u) \| + \| y_d \| \leq c \| u \| + \| y_d \| } \underbrace{ \left\| y(v) - y_h(v) \right\| }_{\leq ch^2 \| v \|} \\
