...
It suffices to show that $3\textsc{Sat}$ is \NP-complete. Reduce \textsc{Sat} to 3\textsc{Sat}.
...
\]
By iterating this for every clause, we obtain a 3\textsc{Sat} instance equivalent to the original instance.
\end{proof}
\begin{theorem} % Thm 5
\label{thm:5}
...
Reduce to 3\textsc{Sat} to \textsc{Directed Hamiltonian Cycle}. Let $F = C_1 \wedge \ldots \wedge C_k$ with variables $x_1, \ldots, x_n$.
...
Reduce 3\textsc{Sat} to \textsc{Vertex Cover}.
