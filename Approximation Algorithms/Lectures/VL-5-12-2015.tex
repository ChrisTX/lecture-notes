...
\IEEEyesnumber\label[equation]{eq:thm48-1} \Longrightarrow& W - \sum_{i \in X'} w_i &<& w_{a_m}
\end{IEEEeqnarray*}
Thus:
\begin{IEEEeqnarray*}{rCl}
...
&\leq& \sum_{i \in X'} c_i + \frac{c_{a_m}}{w_{a_m}} \cdot \underbrace{ \left( W - \sum_{i=1}^{m-1} w_{a_i} - \sum_{i \in X' \setminus X^*} w_i \right) }_{\leq w_{a_m}, \; \text{by \cref{eq:thm48-1}}}
\end{IEEEeqnarray*}
This again gives us:
\begin{IEEEeqnarray*}{r"rCl}
