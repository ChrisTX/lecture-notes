...
\newenvironment{problem}[1][]{\begin{mdframed}[style=theoremframing,frametitle={#1},frametitlefont={\sc},frametitlebelowskip=0pt,backgroundcolor=problemcolor]}{\end{mdframed}}
\newenvironment{algorithm}[1][]{\begin{mdframed}[style=theoremframing,frametitle={#1},frametitlefont={\sc},backgroundcolor=algorithmcolor]}{\end{mdframed}}