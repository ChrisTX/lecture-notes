...
Die eindeutige Lösbarkeit der \ac{PDE} \labelcref{eq:c2e1s1} erfordert Randbedingungen, z.B.
\begin{itemize}
...
u &=& 0 & \text{auf } \Gamma_D, \IEEEyesnumber \label{eq:c2e1s3} \\ % (2.1.3)
(A \nabla u) \cdot \nu &=& g & \text{auf } \Gamma_N,
\end{IEEEeqnarray*}
...
Eine Funktion $u \in H_D^1(\Omega)$ heißt schwache Lösung von \cref{eq:c2e1s1} mit gemischten Randbedingungen \labelcref{eq:c2e1s3}, falls gilt
\begin{equation} % (2.1.4)
\label{eq:c2e1s4}
