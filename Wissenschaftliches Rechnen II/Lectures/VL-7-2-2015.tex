...
\begin{IEEEeqnarray*}{rCl}
	\left\| \underbrace{\frac{u_h^{n+1}-u_h^n}{\Delta t}}_{\dot{u}_h^{n+\frac{1}{2}}} \right\|_{L^2} + \left\| \underbrace{\frac{u_h^n - u_h^{n-1}}{\Delta t}}_{\dot{u}_h^{n+\frac{1}{2}}} \right\|_{L^2}
