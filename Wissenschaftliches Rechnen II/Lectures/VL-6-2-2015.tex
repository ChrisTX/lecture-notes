...
\begin{proof}
	...
	\begin{IEEEeqnarray*}{rCl}\label{eqn:c2e8s5}
		\im{a(u,u)} &=& \kappa\|u\|_{L^2(\Omega)}^2\\
		&\leq& \left| \int_\Omega f\overline{u}\,dx + \int_{\partial\Omega} g\overline{u}\,dS \right|\\
		&\overset{\text{Youngsche UGL}}{\leq}&\frac{1}{2\varepsilon k}\|f\|_{L^2(\Omega)}^2 + \frac{\varepsilon\kappa}{2}\|u\|_{L^2(\Omega)}^2 + \frac{1}{2\kappa}\|g\|_{L^2(\partial\Omega)}^2 + \frac{\kappa}{2}\|u\|_{L^2(\partial\Omega)}^2
	\end{IEEEeqnarray*}
	...
	\begin{IEEEeqnarray*}{rCll}
		(\ref{eqn:c2e8s4})\Rightarrow \|\nabla u\|^2 
			&\leq& \kappa^2\|u\|_{L^2(\Omega)}^2 + \frac{1}{2\kappa^2}\|f\|_{L^2(\Omega)}^2 + \frac{\kappa^2}{2}\|u\|_{L^2(\Omega)}^2\\&& + \frac{1}{2\kappa^2}\|g\|_{L^2(\Omega)}^2 + \frac{\kappa^2}{2}\|u\|_{L^2(\partial\Omega)}^2\\
	...
	\begin{IEEEeqnarray*}{rCl}
		...
		&\overset{\text{2x C.S.U}}\leq& \diam{\Omega} \Big( \underbrace{\|f\|_{L^2(\Omega)}\|\nabla u\|_{L^2(\Omega)} + \|g\|_{L^2(\partial\Omega)}\|\nabla u\|_{L^2(\partial\Omega)}}_{\eqqcolon A}\Big)\\ && {} + \diam{\Omega}\Bigg(\underbrace{\frac{\kappa^2}{2}\|u\|_{L^2(\partial\Omega)}^2}_{\eqqcolon B}\Bigg)\\
		&& {} + \diam{\Omega}\Big(\underbrace{\kappa\|u\|_{L^2(\partial\Omega)}\|\nabla u\|_{L^2(\partial\Omega)}}_{\leq\underbrace{\frac{1}{2\delta}\kappa^2\|u\|_{L^2(\partial\Omega)}}_{\eqqcolon C}+\frac{\delta}{2}\|\nabla u\|_{L^2(\partial\Omega)}^2} \Big).
	\end{IEEEeqnarray*}
	...
	\begin{IEEEeqnarray}{rCl}\label{eqn:c2e8s6}
		\frac{1}{2}\kappa^2\|u\|_{L^2(\Omega)}^2
	...
	\begin{IEEEeqnarray}{rCl}\label{eqn:c2e8s7}
		\|\nabla u\|_{L^2(\Omega)}^2 &\leq& 2\kappa^2 \|u\|_{L^2(\Omega)}^2 + \frac{1}{2}(1+\kappa^2)(\|f\|_{L^2}^1+\|g\|_{L^2}^2)
	\end{IEEEeqnarray}
...
\begin{proof}
	...
	\begin{IEEEeqnarray*}{rCl}
		...
		&\geq&\frac{1}{2C(\Omega)\kappa}\|u\|_\mathcal{H}\|z_u\|_\mathcal{H}. 
	\end{IEEEeqnarray*}
\end{proof}
...
\begin{IEEEeqnarray*}{rCl}
	\sup_{v\in H^2(\Omega)}\inf_{v_h\in\mathcal{P}^{1,0}(\mathcal{T}_h)}\Big( \|v-v_h\|_{L^2(\Omega)} + h\|\nabla(v-\underbrace{v_h}_{=I_h^1v})\|_{L^2(\Omega)} \Big) \leq C_{int}h\|D^2\|_{L^2(\Omega)}.
\end{IEEEeqnarray*}
Die Regularitätstheorie für $-\Delta$ zeigt, dass Lösungen von (\ref{eqn:c2e8s8}) in in $H^2(\Omega)$ liegen, und dass
\begin{IEEEeqnarray*}{rCl}
	\|D^2u\|_{L^2(\Omega)}&\leq& \tilde{C}(\Omega)\Big( \|f-\kappa^2u\|_{L^2(\Omega)} + \|\underbrace{\nabla u\cdot\nu}_{=g-i\kappa u}\|_{H^{1/2}(\partial\Omega)} \Big)\\
	&\overset{\text{\cref{thm:c2e8s1} + Trace UGL}}\leq& C(\Omega)\left(\kappa\|f\|_{L^2(\Omega)} + \kappa\|g\|_{L^2(\partial\Omega)}+\|g\|_{H^{1/2}(\partial\Omega)} \right)
\end{IEEEeqnarray*}
...
\begin{proof}
	...
	\begin{IEEEeqnarray*}{rCl}
		\re{a(u,v)} &=& \underbrace{\re{a(u_h,u_h+\overline{z})}}_{\underset{\text{Beweis \ref{thm:c2e8s1}}}\geq \|u_h\|_\mathcal{H}^2} - \underbrace{\re{a(u_h,z-z_h)}}_{\leq C(\Omega)\|u_h\|_\mathcal{H}^2(\kappa h^2+h)\kappa^2}
		\\
