...
\begin{proof}
	...
	\begin{IEEEeqnarray}{rCl}\label{eqn:c2e8s4}
		...
		&\overset{\text{Youngsche UGL}}\leq& \left| \int_\Omega f\overline{u}\,dx + \int_{\partial\Omega} g\overline{u}\,dS \right|
	\end{IEEEeqnarray}
...
\begin{proof}
	...
	\begin{IEEEeqnarray*}{rCl}
		\re{a(u,v)} &=& \underbrace{\re{a(u_h,u_h+\overline{z})}}_{\underset{Beweis\,\ref{thm:c2e8s1}}\geq \|u_h\|_\mathcal{H}^2} - \underbrace{\re{a(u_h,z-z_h)}}_{\leq C(\Omega)\|u_h\|_\mathcal{H}^2(\kappa h^2+h)\kappa^2}
		\\
