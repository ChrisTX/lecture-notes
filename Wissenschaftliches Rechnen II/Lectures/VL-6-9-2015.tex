...
\begin{remark}
	\cref{eqn:c3e1s2} wird auch LBB Bedingung (Ladyzkenskaya-Babuska Bedingung) genannt.
\end{remark}
...
\begin{theorem}[Ladyzkenskaya-Lemma]\label{thm:c3e2s1}
	\[
		\forall q\in L^2_0(\Omega)\:\exists v\in H^1_0(\Omega)^d
	\]
	derart, dass $div\:v = p$ und
	\[
